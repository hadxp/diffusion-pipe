...
class HYFramepackPipeline(BasePipeline):
    name = 'framepack-hv'
    framerate = 30
    ...
    def __init__(self, config):
        ...
        tokenizer1_path = self.model_config.get('tokenizer1_path', os.path.join(self.args.model_base, 'tokenizer1_path'))
        ...
        text_encoder = TextEncoder(
            ...
            tokenizer_path=tokenizer1_path,
        ...
        tokenizer2_path = self.model_config.get('tokenizer2_path', os.path.join(self.args.model_base, 'tokenizer2_path'))
        ...
        text_encoder_2 = TextEncoder(
            ...
            text_encoder_precision=TYPE_TO_PRECISION[dtype],
            tokenizer_path=tokenizer2_path,
            reproduce=self.args.reproduce,
            logger=logger,
            device='cpu',
        )
